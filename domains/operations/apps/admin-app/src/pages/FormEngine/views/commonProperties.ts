...
// Ant Design placement types (mapped from RSuite TypeAttributes.Placement)
// RSuite used: bottomStart, bottomEnd, topStart, topEnd, leftStart, rightStart, leftEnd, rightEnd
...
type Placement = 
  ...
  | 'rightTop' 
  | 'rightBottom'
  | 'bottomStart'  // Keep RSuite values for backward compatibility
  | 'bottomEnd'
  | 'topStart'
  | 'topEnd'
  | 'leftStart'
